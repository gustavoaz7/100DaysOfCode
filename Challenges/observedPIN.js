...
Can you help us to find all those variations? It would be nice to have a function, that returns an array of all variations for an observed PIN with a length 
of 1 to 8 digits. We could name the function getPINs (get_pins in python). But please note that all PINs, the observed one and also the results, must be strings, 
...
function getPINs(observed) {
  ...
  const digits = {
    ...
    // observed = 1357  (for mental guidance)
  var number = [], PIN = [];
  for (var digit in observed) {
    number.push(digits[observed[digit]]);
  }
  PIN = number[0];
  if (number.length==1) {return number[0];} else {
  for (var i=1; i<number.length; i++) {
    var temp = [];
    for (var j=0; j<PIN.length; j++) {
      for (var k=0; k<number[i].length; k++) {
        temp.push(PIN[j]+number[i][k]);
      }
    }
    PIN = temp;
  }
 ...
 var expectations = {
    ...
    "369": ["339","366","399","658","636","258","268","669","668","266","369","398","256","296","259","368","638","396","238","356","659","639","666",
    		"359","336","299","338","696","269","358","656","698","699","298","236","239"]
  };
