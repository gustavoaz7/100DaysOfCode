...
[9,8,7]
```
Please note that the difference is positive. Such as the above 1 and 9, the difference should be 8, not -8. I think ```abs()``` can help you get the correct 
result ;-)
...
function maxMin(arr1,arr2){
  ...
  for (var index in arr1){
    a.push(Math.abs(arr1[index]-arr2[index]))
  }
  b.push(Math.max(...a));
  b.push(Math.min(...a));
  return b;
