// Retry
/*
Say you have a function primitiveMultiply that, in 50 percent of cases, multiplies two numbers, and in the other 50 percent, raises 
an exception of type MultiplicatorUnitFailure. Write a function that wraps this clunky function and just keeps trying until a call succeeds, 
...
function reliableMultiply(a, b) {
  ...
  for (;;) { 
  	...
  	catch (err) {if (!(err instanceof MultiplicatorUnitFailure)) throw err}
  }
}
